...
import UsuarioSenhaResetarAlterarForm from './UsuarioSenhaResetarAlterarForm';
...
class UsuarioSenhaResetarAlterarView extends React.Component
{
    constructor(props)
    {
        super(props);
        this.state={visao:props.visao == null ? "usuario.senhaConfirmar" : props.visao 
            ...
            ,url:{
                pesquisar:null
               ,salvar:process.env.REACT_APP_SERVER_URL + "/api/usuarios/senhaResetarAlterar/"
               ,consultar:null
               ,excluir:null
           }
        };
...
<div class="card-body">
        ...
        <div>  
            ...
            {this.state.visao=="usuario.senhaConfirmar" ?
                <UsuarioSenhaResetarAlterarForm 
...
export default UsuarioSenhaResetarAlterarView;