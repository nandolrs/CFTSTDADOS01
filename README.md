...
Mas primeiro, precisamos construir um vocabulário pra entender a coisa toda e vou colocar (<termo>) pra destacar. Os serviços (services) baseados em nuvem (cloud) estão disponíveis em praticamente todos continentes do globo terrestre. Distribuições baseadas em container (Docker) reduziram muito o tempo necessário para implementar, empacotar/guardar, testar e implantar soluções de forma segura e com qualidade.
